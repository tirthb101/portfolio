          ...
          <div className="md:col-span-2 flex flex-col gap-6">
            ...
            <div className="bg-content2 p-6 rounded-xl shadow-md">
              ...
              <p className="text-default-600">
                ...
                strong foundation in programming, data structures, and
                algorithms. I&apos;m passionate about software development with
                particular interests in AI, machine learning, and web
                development. My experience spans from web applications to
                AI-driven solutions, including RAG systems and predictive
                maintenance models.
              </p>
            </div>
              ...
              <div className="space-y-4">
                <div>
                  ...
                  <ul className="mt-1 text-default-600 list-disc pl-5 space-y-1">
                    ...
                    <li>
                      Utilized VectorDB, Embedding algorithms and local LLM
                    </li>
                    <li>
